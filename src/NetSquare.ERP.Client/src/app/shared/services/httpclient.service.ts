...
import { baseApiRoutes } from '../routes/baseApiRoutes';
import { ApiResponse } from '../interfaces/apiResponse';
import { ClientConstants } from '../commons/common'
...
export class CommonService {
    ...
    constructor(private httpClient: HttpClient, private router: Router) {
        this.baseUrl = baseApiRoutes.BaseUrl;
    }

    public apiRoutes = baseApiRoutes;
