    ...
    $('.btn-todo-add').on('click', function () {
        ...
        if (item) {
            $('.todo-list').append(
                ...
                '<li>'+ '<span>' +
                    item + '</span>' +
                    '<div class="todo-action"><span class="btn done p-1 icofont-check-circled" onClick="toggleDone(this)"></span><span class="btn text-danger close p-1 icofont-ui-delete" onClick="toggleClose(this)"></span></div>' +
                '</li>'
