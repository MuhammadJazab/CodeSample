...
$(document).ready(function() {
    ...
    var chart = new ApexCharts(
        document.querySelector("#apex-chart-line-Status"),
        options
    );
...
$(document).ready(function() {
    ...
    var chart = new ApexCharts(
        document.querySelector("#apex-chart-basic-line-column"),
        options
    );
...
$(document).ready(function() {
    ...
    var chart = new ApexCharts(
        document.querySelector("#apex-circle-work"),
        options
    );
...
$(document).ready(function() {
    ...
    var chart = new ApexCharts(
        document.querySelector("#apex-circle-task"),
        options
    );
