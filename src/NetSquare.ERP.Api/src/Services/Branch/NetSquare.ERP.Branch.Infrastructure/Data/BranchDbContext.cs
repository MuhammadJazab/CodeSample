//-----------------------------------------------------------------------
// <copyright file="BranchDbContext.cs" company="NetSquare.ERP Limited">
// Copyright (c) NetSquare.ERP Limited. All rights reserved.
// </copyright>
//-----------------------------------------------------------------------

namespace NetSquare.ERP.Branch.Infrastructure.Data;

/// <summary>
/// Defines the <see cref="BranchDbContext" />.
/// </summary>
public class BranchDbContext : DbContext, IBranchDbContext
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="BranchDbContext"/> class.
    /// </summary>
    /// <param name="options">The options<see cref="DbContextOptions{BranchDbContext}"/>.</param>
    /// <param name="httpContextAccessor">The httpContextAccessor<see cref="IHttpContextAccessor"/>.</param>
    public BranchDbContext(DbContextOptions<BranchDbContext> options, IHttpContextAccessor httpContextAccessor)
    ...
    /// </summary>
    public DbSet<BranchSeedingEntry>? SeedingEntries { get; set; }
