...
namespace NetSquare.ERP.HumanResource.Infrastructure.Repositories;
...
public class GenericRepository<T> : IGenericRepository<T> where T : BaseEntity
{
    ...
    /// Defines the context.
    /// </summary>
    private readonly IHumanResourceDbContext context;

    /// <summary>
    /// Initializes a new instance of the <see cref="GenericRepository{T}"/> class.
    /// </summary>
    /// <param name="context">The context<see cref="IHumanResourceDbContext"/>.</param>
    public GenericRepository(IHumanResourceDbContext context)
    {
