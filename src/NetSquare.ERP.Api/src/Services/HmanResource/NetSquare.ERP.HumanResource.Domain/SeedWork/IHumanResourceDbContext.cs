//-----------------------------------------------------------------------
// <copyright file="IHumanResourceDbContext.cs" company="NetSquare.ERP Limited">
...
/// <summary>
/// Defines the <see cref="IHumanResourceDbContext" />.
/// </summary>
public interface IHumanResourceDbContext
{
    /// <summary>
    /// The Set.
    /// </summary>
