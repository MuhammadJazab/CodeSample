...
/// <summary>
/// Defines the <see cref="CustomHumanResourceFilterMiddleware" />.
/// </summary>
public class CustomHumanResourceFilterMiddleware
{
    /// <summary>
    /// Defines the _next.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CustomHumanResourceFilterMiddleware"/> class.
    /// </summary>
    /// <param name="next">The next<see cref="RequestDelegate"/>.</param>
    public CustomHumanResourceFilterMiddleware(RequestDelegate next)
    {
        _next = next;
    }
